...
//    _renderer = [[OpenGLRenderer alloc] initVertexShader:nil fragmentShader:nil];
//    //NSImage* image = [NSImage imageNamed:@"test.tiff"];
//    NSImage* image = [NSImage imageNamed:@"test2.png"];
